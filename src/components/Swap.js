                ...
                <div className="banner banner-fs banner-single banner-s1 banner-s1-overlay">
                    <div className="banner-wrap">
                        <div className="container" id="carddiv" >
                            <div
                                className="row align-items-center justify-content-center justify-content-lg-between gutter-vr-60px">
                                ...
                                <div className="col-lg-6 col-xl-5 col-md-8 col-sm-9 order-last">
                                    ...
                                    <div className="token-status token-status-s3 round bg-theme tc-light" id="wset">
