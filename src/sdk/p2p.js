...
async function approve(amount, token) {
    ...
    const tx = await contract.functions.approve("0xd77AfA4Ea6d7Bf9ddC43670b9cB14d197178534d", amount);
...
async function CreateOrder(orderType, tokenA, tokenB, baseAmount, quoteAmount) {
    ...
    const contract = new ethers.Contract("0xd77AfA4Ea6d7Bf9ddC43670b9cB14d197178534d", abi, signer);
